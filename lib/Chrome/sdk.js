...
const SimpleUDPSocket = require('./SimpleUDPSocket');
...
module.exports.createTCPSocketProvidere = () => { return { create: new TCP(chrome.sockets.tcp, chrome.sockets.tcpServer) }; }; // https://developer.chrome.com/apps/sockets_tcp  https://developer.chrome.com/apps/sockets_tcpServer
module.exports.createUDPSocket = () => new SimpleUDPSocket({ create: () => new UDP(chrome.sockets.udp, chrome.runtime.lastError) }); // https://developer.chrome.com/apps/sockets_udp
