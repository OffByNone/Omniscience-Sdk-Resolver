...
const SimpleTCPSocketClass = require('./SimpleTCPSocket');
const SocketSenderClass = require('./SocketSender.js');
...
module.exports.RawTCPProvider = { create: () => new TCPSocket(Cc["@mozilla.org/tcp-socket;1"].createInstance(Ci.nsIDOMTCPSocket)) };
module.exports.createSimpleTCP = () => new SimpleTCP(module.exports.SimpleTCPSocket());
module.exports.createSocketSender = () => new SocketSenderClass();
module.exports.SimpleTCPSocket = () => new SimpleTCPSocketClass(module.exports.timers(), module.exports.RawTCPProvider , new SocketSenderClass());
