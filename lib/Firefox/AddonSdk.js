...
module.exports.btoa = () => require("api-utils/base64").encode; //https://developer.mozilla.org/en-US/Add-ons/SDK/High-Level_APIs/base64
...
module.exports.createIPResolver = () => new IPResolver(Cc["@mozilla.org/network/dns-service;1"].getService(Ci.nsIDNSService), {
	create: () => module.exports.createUDPSocket()
}); // https://developer.mozilla.org/en-US/docs/Mozilla/Tech/XPCOM/Reference/Interface/nsIDNSService

module.exports.createRawTCPProvider = () => { return { create: () => new TCPSocket(Cc["@mozilla.org/tcp-socket;1"].createInstance(Ci.nsIDOMTCPSocket)) }; };
module.exports.createSimpleTCP = () => new SimpleTCP(module.exports.createSimpleTCPSocket());
module.exports.createSocketSender = () => new SocketSender();
module.exports.createSimpleTCPSocket = () => new SimpleTCPSocket(module.exports.timers(), module.exports.createRawTCPProvider(), new SocketSender());
